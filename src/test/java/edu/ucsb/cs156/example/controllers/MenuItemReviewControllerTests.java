...
public class MenuItemReviewControllerTests extends ControllerTestCase {
  ...
  public void logged_out_users_cannot_put() throws Exception {
    ...
    String requestBody = new ObjectMapper().writeValueAsString(review);
  ...
  public void admin_can_edit_an_existing_review() throws Exception {
    ...
    when(menuItemReviewRepository.findById(eq(1L)))
    ...
    mockMvc
        ...
        .andExpect(status().isOk())
        .andExpect(jsonPath("$.id").value(1))
        .andExpect(jsonPath("$.itemId").value("burger2"))
        .andExpect(jsonPath("$.reviewerEmail").value("updated@ucsb.edu"))
        .andExpect(jsonPath("$.stars").value(4))
        .andExpect(jsonPath("$.comments").value("Updated review"));

    org.mockito.Mockito.verify(menuItemReviewRepository).save(existingReview);
  }
